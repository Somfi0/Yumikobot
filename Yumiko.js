...
client.on('guildMemberAdd', (member) => {
    ...
    let rules = '811238184084176897';
    let embed = new Discord.MessageEmbed()
    .setDescription(`▨Приветствую тебя <@${member.id}> на нашем сервере 𝘠𝘶𝘮𝘪𝘬𝘰. Здесь тебя ждёт дружелюбная администрация, крутое оформление сервера, а самое главное, наш собственный бот! Прежде чем ты начнёшь что-то делать, прочти ${member.guild.channels.cache.get(rules).toString()}, а потом можешь пойти общаться в #・⊰💬⊱・чатик. Если у вас есть желание можете изменить цвет своего имени здесь #deleted-channel, а чтобы выбрать пол зайдите сюда #・⊰🎉⊱・пол. Также можете оставить отзыв здесь #・⊰💐⊱・отзывы. Желаю вам приятного времяпровождения на нашем сервере!:kissing_heart:▨`)
    .setColor('#f5ec42')
